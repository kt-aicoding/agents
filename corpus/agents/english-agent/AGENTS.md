...
This repository powers `english.rxcloud.group`, a Next.js English-learning assistant with Supabase auth/data, Ark-powered conversation, SRS review, notifications, and Vercel cron jobs.

## Working Rules

- Treat `.env.local` and production Vercel/Supabase/Ark credentials as sensitive. Keep real keys out of git.
