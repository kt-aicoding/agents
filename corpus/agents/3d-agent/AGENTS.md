...
- Stack: Next.js 16, React 19, Tailwind CSS v4, Supabase, GLM/OpenAI-compatible API
...
- Required production secret: `GLM_API_KEY`; Supabase variables are optional unless persistence is enabled.
